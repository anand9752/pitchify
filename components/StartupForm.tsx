...
const StartupForm = () => {
  ...
  const handleFormSubmit = async (prevState: FormSubmitState, formData: FormData) => {
    try {
      const formValues = {
  ...
  const [formState, formAction, isPending] = useActionState<FormSubmitState>(handleFormSubmit, {
    error: "",
    status: "INITIAL",
  });
